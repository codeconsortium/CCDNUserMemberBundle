...
class BaseController extends ContainerAware
{
    ...
    /**
     *
     * @var \CCDNUser\MemberBundle\Manager\UserManager $userManager
     */
    private $userManager;
     ...
     * @return string
     */
    protected function trans($message, $params = array(), $bundle = 'CCDNUserMemberBundle')
    {
     ...
     *
     * @access protected
     * @return \CCDNUser\MemberBundle\Manager\UserManager
     */
    protected function getUserManager()
    {
        if (null == $this->userManager) {
            $this->userManager = $this->container->get('ccdn_user_member.manager.user');
        }
